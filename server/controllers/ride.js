...
// Example in your ride controller or a new controller for locations

export const getUniqueLocations = async (req, res) => {
  try {
    // Assuming 'origin.place' and 'destination.place' are the fields
    const origins = await Ride.distinct("origin.place");
    const destinations = await Ride.distinct("destination.place");

    // Combine and deduplicate
    const locations = [...new Set([...origins, ...destinations])];
