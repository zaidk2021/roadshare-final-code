...
import { createRide, getAllRides, getRide, updateRide, deleteRide, findRides, joinRide,getUniqueLocations} from "../controllers/ride.js";
...
router.get("/getUniqueLocations", getUniqueLocations)
